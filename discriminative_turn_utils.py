...
def context_print(utter_id, conversation, turns_before, turns_after, individual=False):
...
def get_urls(experiment_ids=[], write=False,
             base_path='/group/project/cstr3/html/sarenne/test_qualtrics/',
    ...
    """
    nfs_path = '/afs/inf.ed.ac.uk/user/s13/s1301730/Documents/discriminitive_turns/qualtrics_resources'
    ...
    if write:
        with open(nfs_path + '/urls.json', 'w+') as fs:
